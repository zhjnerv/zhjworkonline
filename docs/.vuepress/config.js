...
module.exports = {
  ...
  head: [ // 注入到页面<head> 中的标签，格式[tagName, { attrName: attrValue }, innerHTML?]
    ...
    ['script', { src: "https://www.googletagmanager.com/gtag/js?id=UA-174264353-1",async: true}],
    ['script', {},
  ...
  themeConfig: { // 主题配置
    ...
    logo: '/img/网页logo.png', // 导航栏logo
    repo: 'zhjnerv/zhjworkonline', // 导航栏右侧生成Github链接
    ...
    author: { // 文章默认的作者信息，可在md文件中单独配置此信息 String | {name: String, link: String}
      name: 'zhjwork', // 必需
      link: 'https://github.com/zhjnerv' // 可选的
    },
    blogger:{ // 博主信息，显示在首页侧边栏
      avatar: 'https://p.sda1.dev/0/aedd40fe0ac95fdf96557d46aeb0b080/2020-07-25_00-09-18.jpg',
      name: 'Overl',
      slogan: '知产界的留级生，不再做重复的事情，记录生活的教训和幸福'
    },
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:zhjwork@gmail.com'
        },
        {
          iconClass: 'icon-github',
          title: 'GitHub',
          link: 'https://github.com/zhjnerv'
        },
        {
          iconClass: 'icon-erji',
          title: '听音乐',
          link: 'https://open.spotify.com/playlist/37i9dQZF1CAm1rVIFk2nFh?si=NQ80q-NDTL2PjwcZRkW6eQ'
        }
      ]
    },
    footer:{ // 页脚信息
  ...
  plugins: [ // 插件
    ...
    ['thirdparty-search', { // 可以添加第三方搜索链接的搜索框（原官方搜索框的参数仍可用）
      thirdparty: [ // 可选，默认 []
        ...
        {
          title: '通过百度搜索本站的',
          frontUrl: 'https://www.baidu.com/s?wd=site%3Azhjwork.online%20'
        }
      ]
    }],
    ...
    [
      ...
      {
        hm: 'dfc615edabeab5d88e99daad7d7711d0'
      }
    ],
    [
      ...
      // },
      {
        choosen: 'gitalk', 
        options: {
          clientID: '3eebb078e2a4d9310579',
          clientSecret: '2f8c23522b43a859efb91b5b45d5897344e16da3',
          repo: 'zhjworkonline', // GitHub 仓库
          owner: 'zhjnerv', // GitHub仓库所有者
